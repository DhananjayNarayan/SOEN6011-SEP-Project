...
/**
 * A class with test cases to check some functional and non-functional requirements
...
public class f5ExponentialFunctionTest {
	...
	/**
	 * A test case to verify correctness of solution with a sample set of values
	 * @throws Exception
	 */
	@Test
